...
class OmnibricksGamepadDemoExtension(omni.ext.IExt):
    def on_startup(self, ext_id):
        ...
        self.sphere_material_handler = SphereMaterialHandler(self.stage)
        ...
        self.ui_components = UIComponents(ext_id, self.gamepad_event_handler, self.sphere_material_handler)
